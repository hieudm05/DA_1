                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                <img src="<?= $avatar?>" alt="Avatar" class="rounded-circle border border-danger mb-3" width="100" height="100">
                                ...
                                <form>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" class="form-control" id="phone" name="sdt" value="<?= $sdt?>" placeholder="Nhập số điện thoại của bạn">
                                        </div>
                                    </div>
                                    <div class="mb-3">
